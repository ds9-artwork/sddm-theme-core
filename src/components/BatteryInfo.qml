...
RowLayout {
    ...
    PlasmaComponents.Label {
        ...
        text: {
            ...
            case "NoCharge":
            case "Discharging":
                return i18nd("org.hawaii.lookandfeel.desktop", "%1\% charge remaining", batteryIcon.percent)
            case "FullyCharged":
                return i18nd("org.hahwaii.lookandfeel.desktop", "Fully charged")
            default:
                return i18nd("org.hawaii.lookandfeel.desktop","%1\%, charging", batteryIcon.percent)
            }
        }
